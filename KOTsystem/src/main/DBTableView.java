...
public class DBTableView {
	...
	public static void printResultSet(ResultSet rs, int maxStringColWidth) {
		try {
			 ...
			 * and adjusted the column widths. We cannot start printing just yet because we
			 * have to prepare a row separator String.
			 */
	...
	public static void printActionOrderWithID(Connection conn, String tableName) {
		if (conn == null) {
			System.err.println("DBTablePrinter Error: No connection to database (Connection is null)!");
			return;
		}
		...
		try {
			...
			String sqlSelectAll = "SELECT * FROM " + tableName + "WHERE status = 'action'";
			stmt = conn.createStatement();
			rs = stmt.executeQuery(sqlSelectAll);
	...
	public static void printPendingOrderWithID(Connection conn, String tableName) {
		if (conn == null) {
			System.err.println("DBTablePrinter Error: No connection to database (Connection is null)!");
			return;
		}
		...
		try {
			...
			String sqlSelectAll = "SELECT * FROM " + tableName + "WHERE status = 'pending'";
			stmt = conn.createStatement();
			rs = stmt.executeQuery(sqlSelectAll);
	...
	public static void printDoneOrderWithID(Connection conn, String tableName) {
		if (conn == null) {
			System.err.println("DBTablePrinter Error: No connection to database (Connection is null)!");
			return;
		}
		...
		try {
			...
			String sqlSelectAll = "SELECT * FROM " + tableName + "WHERE status = 'done'";
			stmt = conn.createStatement();
			rs = stmt.executeQuery(sqlSelectAll);
	...
	public static void printOrderWithID(Connection conn, String tableName, String id) {
		if (conn == null) {
			System.err.println("DBTablePrinter Error: No connection to database (Connection is null)!");
			return;
		}
		...
		try {
			...
			String sqlSelectAll = "SELECT * FROM " + tableName + "WHERE OrderId = '" + id + " '";
			stmt = conn.createStatement();
			rs = stmt.executeQuery(sqlSelectAll);
	...
	public static void printbillFoods(Connection conn, String orderID) {
		if (conn == null) {
			System.err.println("DBTablePrinter Error: No connection to database (Connection is null)!");
			return;
		}
		...
		try {
			...
			String sqlSelectAll = "SELECT `foodName`, `quantity`, `price`, `type` FROM `orders` WHERE OrderId = '"
					+ orderID + "'";
			stmt = conn.createStatement();
			rs = stmt.executeQuery(sqlSelectAll);
	...
	public static void printconfirmedBill(Connection conn, String tableName) {
		if (conn == null) {
			System.err.println("DBTablePrinter Error: No connection to database (Connection is null)!");
			return;
		}
		...
		try {
			...
			String sqlSelectAll = "SELECT * FROM " + tableName + "WHERE status = 'confirmed'";
			stmt = conn.createStatement();
			rs = stmt.executeQuery(sqlSelectAll);
